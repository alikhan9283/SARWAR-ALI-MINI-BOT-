...
// Auto React Plugins Run
for (let plugin of pluginLoader.plugins.values()) {

    if (!isCmd && plugin.auto && plugin.autoExecute) {

        await plugin.autoExecute(sock, m, {
            config,
            sender
        });
...
${pluginMenuSections}`;
                ...
                await sock.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        ...
                        isForwarded: false,
                        externalAdReply: {
                            title: "𝐒𝐀𝐑𝐖𝐀𝐑 𝐀𝐋𝐈 𝐌𝐃 Bot",
                            body: "SARWAR ALI MD Official Channel",
                            mediaType: 3,
                            thumbnailUrl: config.thumbUrl,
                            mediaUrl: "https://t.me/sarwarali1230",
                            sourceUrl: "https://t.me/sarwarali1230",
